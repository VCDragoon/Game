...
class PlanetSystem:
    ...
    def make_content_list(self):
        ...
        self.orbitcontents = dict.fromkeys(self.__orbitarray)
        ...
        if self.gasarrangement is not 'None':
            ...
            self.orbitcontents[self.__firstgasorbit] = GasGiant(
    ...
    def place_gas_giants(self):
        ...
        rollorbits = [orb for orb in self.__orbitarray if self.orbitcontents[orb] is None]
    ...
    def gas_giant_bonus(self, orbit):
        ...
        if not bonus:
            ...
            if gg_index > 0:
                bonus = self.__orbitarray[gg_index - 1] < self.snowline
        return bonus
    ...
    def fill_orbits(self):
        ...
        roll_orbits = [orb for orb in self.__orbitarray if self.orbitcontents[orb] is None]
        roll_orbits.sort()
    ...
    def has_garden(self):
        ret = False
        for k, p in self.orbitcontents.items():
